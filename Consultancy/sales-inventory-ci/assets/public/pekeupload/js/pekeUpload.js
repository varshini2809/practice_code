            ...
            replacehtml: function () {
                ...
                switch (options.dragMode) {
                    ...
                    case false:
                        switch (options.bootstrap) {
                            case true:
                                html = '<a href="javascript:void(0)" class="btn btn-primary btn-sm btn-upload pkuparea"> <i class="glyphicon glyphicon-upload"></i> ' + options.btnText + "</a>";
                                break;
                            case false:
                ...
                switch (options.bootstrap) {
                    case true:
                        ...
                        if (options.showFilename) {
                            var progress = $('<div class="col-md-7"><div class="progress" style="height:30px;"><div class="pkuppbr progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="line-height:30px"></div></div></div>').appendTo(newRow);
                        ...
                        $('<a href="javascript:void(0);" class="btn btn-danger pkdel btn-sm" >' + options.delfiletext + '</a>').appendTo(dismiss);
                        break;
                    case false:
